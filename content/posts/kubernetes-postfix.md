...
date: 2020-08-25
draft: false
description: "Migrating Postfix with OpenDKIM from a $1 VPS to Kubernetes — ConfigMaps, Secrets, and a Dockerfile that bundles everything in one container."
tags:
  - kubernetes
  - postfix
  - email
  - dkim
featuredImage: /images/kubernetes-postfix/vps.jpg
images:
  - "/images/kubernetes-postfix/vps.jpg"
---

![VPS to Kubernetes migration](/images/kubernetes-postfix/vps.jpg)
...
![MicroK8s deployment](/images/kubernetes-postfix/microk8s.jpg)
...
![Postfix log output](/images/kubernetes-postfix/postfixlog.jpg)
...
![Email options](/images/kubernetes-postfix/emailoption.jpg)
